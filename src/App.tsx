      ...
      <div className="w-full z-10 min-h-screen flex flex-col items-center text-white">
        ...
        <div className="fixed top-0 left-0 w-full px-4 pt-8 z-10 flex flex-col items-center text-white">
          <div className="w-full cursor-pointer">
            <div className="bg-[#1f1f1f] text-center py-2 rounded-xl">
              <p className="text-lg">Вернуться в Telegram <Arrow size={18} className="ml-0 mb-1 inline-block" /></p>
            </div>
          </div>
          <div className="mt-12 text-5xl font-bold flex items-center">
            <img src={coin} width={60} height={60} />
        ...
        <div className="fixed bottom-0 left-0 w-full px-4 pb-4 z-10"> 
          <div className="w-full flex justify-between gap-2">
            ...
            <div className="w-full bg-gradient-to-r from-[#1e90ff] to-[#6a5acd] py-4 rounded-2xl flex justify-around">
          ...
          <div className="w-full bg-[#1e90ff] rounded-full mt-4">
            <div
        ...
        <div className="flex-grow flex items-center justify-center">
          <div className="relative mt-4" onClick={handleClick}>
            ...
            <div
              key={click.id}
              className="absolute text-5xl font-bold opacity-0 no-select"
              style={{
                top: `${click.y - 42}px`,
                left: `${click.x - 28}px`,
